...
const OneStepPass = SepCon.createComponent('props-passer-1-step-pass', {
    state: {
        methods: {
            local: {
                onclick1(next) { console.log('onclick 1'); next(); },
                onclickCb(next, res) {
...
const TwoStepsPass = SepCon.createComponent('props-passer-2-steps-pass', {
    state: {
        methods: {
            local: {
                onclick2(next) { console.log('onclick 2'); next(); },
            },
        },
        change() {
            return false;
...
const ThreeStepsPass = SepCon.createComponent('props-passer-3-steps-pass', {
    state: {
        methods: {
            local: {
                onclick3(next) { console.log('onclick 3'); next(); }
            }
        },
        //change() {
        //    return false;
...
export default SepCon.createComponent('props-passer', {
    state: {
        props: {
